        ...
        <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:justify-center">
          ...
          {secondaryCta && (
            <Link
              ...
              className="inline-flex items-center justify-center rounded-lg border border-slate-300 px-6 py-3 text-sm font-medium text-slate-700 transition-all hover:bg-slate-50"
            >
              {secondaryCta.label}
            </Link>
          )}
